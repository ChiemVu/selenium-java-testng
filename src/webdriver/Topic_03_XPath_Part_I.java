...
public class Topic_03_XPath_Part_I {
	...
	public void TC_02_Invalid_Email() {
		driver.get("https://alada.vn/tai-khoan/dang-ky.html");
		//Action
		driver.findElement(By.id("txtFirstname")).sendKeys("Micheal Jonh");
	...
	public void TC_03_Incorrect_Email() {
		...
		//Action
		driver.findElement(By.id("txtFirstname")).sendKeys("Micheal Jonh");
		driver.findElement(By.id("txtEmail")).sendKeys("chiemvt@gmail.com");
		driver.findElement(By.id("txtCEmail")).sendKeys("chiemvt@gmail.net");
		driver.findElement(By.id("txtPassword")).sendKeys("12345678");
		driver.findElement(By.id("txtCPassword")).sendKeys("12345678");
		driver.findElement(By.id("txtPhone")).sendKeys("0123456789");
	...
	public void TC_04_Invalid_Password() {
		...
		driver.findElement(By.id("txtFirstname")).sendKeys("Micheal Jonh");
		driver.findElement(By.id("txtEmail")).sendKeys("chiemvt@gmail.com");
		driver.findElement(By.id("txtCEmail")).sendKeys("chiemvt@gmail.com");
	...
	public void TC_05_Incorrect_Password() {
		...
		driver.findElement(By.id("txtCPassword")).sendKeys("1236777");
		driver.findElement(By.id("txtPhone")).sendKeys("0123456789");
	...
	public void TC_06_Invalid_Phone() {
		...
		driver.findElement(By.id("txtPhone")).sendKeys("098765432445");
		//verify 2
		Assert.assertEquals(driver.findElement(By.id("txtPhone-error")).getText(), "Số điện thoại phải từ 10-11 số.");
		
		//Action 3
		driver.findElement(By.id("txtPhone")).clear();
		driver.findElement(By.id("txtPhone")).sendKeys("98765432445");
		//verify 3
